...
public class PHCTest {
    ...
    public void pbkdf2Test3() {
        ...
        assertEquals(String.format("$pbkdf2$alg=HmacSHA1,c=4096$%s$%s", encoder.encodeToString(salt), hash), phc.toString()); // NOSONAR
    }
    ...
    public void pbkdf2Test5() {
        char[] pstring = "passwordPASSWORDpassword".toCharArray();
    ...
    public void pbkdf2Test6() {
        char[] pstring = "pass\0word".toCharArray();
    ...
    public void testArgon2iTest1() {
        ...
        PHC phc = PHC.builder(Argon2i.getInstance())
                .withSalt(salt)
    ...
    public void testArgon2iTest8() {
        char[] pstring = "differentpassword".toCharArray();
        byte[] salt = SOMESALT.getBytes(StandardCharsets.US_ASCII);
        PHC phc = PHC.builder(Argon2i.getInstance())
                .withSalt(salt)
                .withParam(Argon2i.T, 2)
    ...
    public void testArgon2dTest1() {
        ...
        PHC phc = PHC.builder(Argon2d.getInstance())
                .withSalt(salt)
    ...
    public void testArgon2idTest1() {
        ...
        Arrays.fill(secret, (byte)0x03);
        Arrays.fill(data, (byte)0x04);
        PHC phc = PHC.builder(Argon2id.getInstance())
                .withSalt(salt)
    ...
    public void testPasswordValidation() {
        var phc = PHC.parse("$pbkdf2$alg=HmacSHA512,c=4096$E3nl4k+qzPH2bDYUHBEeCkbx594h431K9wYaqrSun90$G2H7TEl/ujgoe6XM/1926saYNo7HLIoOvLTUqVpT3fQnMDdv+ZwrplqOoqw6h3f6JpIOx5XS5NM2cC+HXG8rGQ");
        assertTrue(phc.validate("passwordWithWhichToTest".toCharArray()));
    }

    @Test
    public void testPasswordValidationFail() {
        var phc = PHC.parse("$pbkdf2$alg=HmacSHA512,c=4096$E3nl4k+qzPH2bDYUHBEeCkbx594h431K9wYaqrSun90$G2H7TEl/ujgoe6XM/1926saYNo7HLIoOVLTUqVpT3fQnMDdv+ZwrplqOoqw6h3f6JpIOx5XS5NM2cC+HXG8rGQ");
        assertFalse(phc.validate("passwordWithWhichToTest".toCharArray()));
    }

    @Test
    public void testPBKDF2Algs() {
        try {
            Arrays.stream(PBKDF2.Algorithm.values()).forEach(
                    a -> PHC.builder(PBKDF2.getInstance())
